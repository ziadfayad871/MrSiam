...
const ROUTE_LABELS: Record<string, string> = {
  ...
  '/teacher/attendance': 'تحضير اليوم',
  '/teacher/attendance/monthly': 'تقرير الحضور الشهري',
  '/teacher/center-exams': 'امتحانات السنتر',
  '/teacher/analytics': 'التحليلات',
  '/teacher/live': 'البث المباشر',
  '/secretary/students': 'إدارة الطلبة',
  '/secretary/attendance': 'التحضير اليومي',
  '/secretary/attendance/monthly': 'تقرير الحضور الشهري',
  '/secretary/center-exams': 'امتحانات السنتر',
